...
public class Animal extends Activity {
	...
	private void showInfo() {
    	...
    	String url = "http://10.0.3.2/SouthNationalParkTravel/getAnimal.php";
    	
    	Intent intent= getIntent();
    	final String id = intent.getStringExtra("pid"); 

		List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("animalID", id));
        
        //รับค่า id เพื่อส่งต่อไปยัง หน้าอื่นๆ
        btn_topography.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent topography = new Intent(Animal.this, Topography.class);
        ...
        btn_climate.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent climate = new Intent(Animal.this, Climate.class);
        ...
        btn_plant.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent plant = new Intent(Animal.this, Plant.class);
        ...
        btn_animal.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent animal = new Intent(Animal.this, Animal.class);
